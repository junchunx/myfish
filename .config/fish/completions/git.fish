...
complete -f -c git -n '__fish_git_using_command clean' -s q -l quiet -d 'do not print names of files removed'
complete -f -c git -n '__fish_git_using_command clean' -s n -l dry-run -d 'dry run'
complete -f -c git -n '__fish_git_using_command clean' -s f -l force -d 'force'
complete -f -c git -n '__fish_git_using_command clean' -s i -l interactive -d 'interactive cleaning'
complete -f -c git -n '__fish_git_using_command clean' -s d -d 'remove whole directories'
complete -f -c git -n '__fish_git_using_command clean' -s e -l exclude -d 'add <pattern> to ignore rules'
complete -f -c git -n '__fish_git_using_command clean' -s x -d 'remove ignored files, too'
